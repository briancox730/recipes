...
SQL Query uses exec_params rather than string interpolation.  Use .exec_params when issuing SQL queries that contain user input.
...
All changes in a commit are conceptually related. Needs Improvement
...
Looks good. Check out the pg gem docs on how to use the .exec_params method: http://deveiate.org/code/pg/PG/Connection.html Try limiting your erb files to contain one tag per line. This will make them easier to read.
```
